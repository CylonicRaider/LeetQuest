define([
    ...
    var Game = Class.extend({
        ...
        setup: function (
            ...
            this.setRenderer(
                new Renderer(this, canvas, background, foreground),
            );
        ...
        updateCursorLogic: function () {
            ...
            if (this.hoveringMob && this.started) {
                ...
                (this.hoveringItem || this.hoveringChest) &&
                this.started
            ) {
                this.setCursor("loot");
                this.hoveringTarget = false;
                ...
                if (this.renderer.mobile || this.renderer.tablet) {
                    entity.onDirty(function (e) {
                        if (self.camera.isVisible(e)) {
                            e.dirtyRect =
                                self.renderer.getEntityBoundingRect(e);
        ...
        registerEntityDualPosition: function (entity) {
            if (entity) {
                ...
                if (entity.nextGridX >= 0 && entity.nextGridY >= 0) {
                    this.entityGrid[entity.nextGridY][entity.nextGridX][
                        entity.id
                    ] = entity;
                    if (!(entity instanceof Player)) {
                        this.pathingGrid[entity.nextGridY][
                            entity.nextGridX
                        ] = 1;
                    }
                }
        ...
        connect: function (started_callback) {
            ...
            this.client.onEntityList(function (list) {
                ...
                self.obsoleteEntities = _.reject(
                    self.entities,
                    function (entity) {
                        return (
                            _.include(knownIds, entity.id) ||
            ...
            this.client.onWelcome(function (id, name, x, y, hp) {
                ...
                self.player.onStep(function () {
                    ...
                    if (
                        self.isZoningTile(self.player.gridX, self.player.gridY)
                    ) {
                        self.enqueueZoningFrom(
                            self.player.gridX,
                            self.player.gridY,
                        );
                    }
                    ...
                    if (!self.entityIdExists(entity.id)) {
                        try {
                            if (entity.id !== self.playerId) {
                                entity.setSprite(
                                    self.sprites[entity.getSpriteName()],
                                );
                                ...
                                if (entity instanceof Character) {
                                    ...
                                    entity.onStep(function () {
                                        if (!entity.isDying) {
                                            self.registerEntityDualPosition(
                                                entity,
                                            );
                                    ...
                                    if (entity instanceof Mob) {
                                        if (targetId) {
                                            var player =
                                                self.getEntityById(targetId);
                                            if (player) {
                                                self.createAttackLink(
                                                    entity,
                                                    player,
                                                );
                                            }
                ...
                self.client.onPopulationChange(function (
                    worldPlayers,
                    totalPlayers,
                ) {
        ...
        getFreeAdjacentNonDiagonalPosition: function (entity) {
            ...
            entity.forEachAdjacentNonDiagonalPosition(function (
                x,
                y,
                orientation,
            ) {
