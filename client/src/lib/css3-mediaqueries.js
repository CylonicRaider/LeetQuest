...
var cssHelper = (function () {
    ...
    var _1e = function () {
        ...
        for (var i = 0; i < _22.length; i++) {
            var _23 = _22[i];
            if (
                _23.getAttribute("rel").indexOf("style") > -1 &&
                _23.href &&
                _23.href.length !== 0 &&
                !_23.disabled
            ) {
                ...
                _c(
                    ...
                    function (_28) {
                        _28 = _11(_28).replace(
                            _3.RELATIVE_URLS,
                            "url(" +
                                _27.substring(0, _27.lastIndexOf("/")) +
                                "/$1)",
                        );
...
domReady(
    (function enableCssMediaQueries() {
                    ...
                    if ("width" === _41.substring(l - 5, l)) {
                        ...
                        if ("height" === _41.substring(l - 6, l)) {
                            ...
                            if (
                                ...
                                if (
                                    "color-index" === _41.substring(l - 11, l)
                                ) {
        ...
        var _4d = function (mql) {
            ...
            if (s.length > 0) {
                _39[_39.length] = cssHelper.addStyle(
